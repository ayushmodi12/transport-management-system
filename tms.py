...
google = oauth.register(
    name='google',
    client_id='157933558199-43t3o2npoelq8db2u95pfhq0enitku7h.apps.googleusercontent.com', # REPLCAE WITH YOUR CLIENT ID
    client_secret='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', # REPLACE WITH YOUR CLIENT SECRET
...
if __name__ == "__main__":
    ...
    app.config['MAIL_USERNAME']= 'username' # REPLACE WITH YOUR EMAIL ID
